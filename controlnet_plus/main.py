...
from external.ControlNetPlus.models.controlnet_union import ControlNetModel_Union
from external.ControlNetPlus.pipeline.pipeline_controlnet_union_sd_xl import (
...
prompt = "bee floating around the flower. The flower is now green"
negative_prompt = "longbody, lowres, bad anatomy, bad hands, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality"


controlnet_img = cv2.imread("input.jpg")
